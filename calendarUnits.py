...
class Year:
    ...
    def date(self) -> int:
        ...
        if self.Rosh_Hashana() == 7 and self.molad.days == 7:
            ...
            self.my_date = objectiveMolad.days
        else:
            self.my_date = objectiveMolad.days \
    ...
    def whole_months(self) -> list:
        ...
        self.my_whole_months = [True, False] * 6
        ...
        if self.placeInCycle in LEAP_YEARS: self.my_whole_months.insert(5, True)
        #8:6
