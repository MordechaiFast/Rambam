...
def test_all_dechios():
    ...
    for i in range(1, 100):
        ...
        if   thisYear.molad.days == 1:
            assert thisYear._Rosh_Hashana_day == 2
            if not wantedYears[0]: wantedYears[0] = thisYear
        elif thisYear.molad.days == 4: 
            assert thisYear._Rosh_Hashana_day == 5
            if not wantedYears[1]: wantedYears[1] = thisYear
        elif thisYear.molad.days == 6:
            assert thisYear._Rosh_Hashana_day == 7
            if not wantedYears[2]: wantedYears[2] = thisYear
        # 7:2
        elif(thisYear.molad.days == 2 
         and thisYear.molad.hours >= 18):
            assert thisYear._Rosh_Hashana_day == 3
        ...
        # 7:3
            ...
            assert thisYear._Rosh_Hashana_day == 2
            if not wantedYears[5]: wantedYears[5] = thisYear
        elif thisYear.molad.days == 3 and thisYear.molad.hours >= 18:
            assert thisYear._Rosh_Hashana_day == 5
            if not wantedYears[6]: wantedYears[6] = thisYear
        ...
        # More cases where the day of Rosh Hashanah is the day of the molad
         ...
         and thisYear.placeInCycle in LEAP_YEARS):
            ...
            assert thisYear._Rosh_Hashana_day == 5
            if not wantedYears[13]: wantedYears[13] = thisYear
        elif thisYear.molad.days == 7 and thisYear.molad.hours < 18:
            assert thisYear._Rosh_Hashana_day == 7
